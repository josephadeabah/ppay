        ...
        <nav className="mx-auto max-w-[52.5rem] p-6 lg:max-w-[78rem]">
          <div className="relative flex items-center gap-x-4">
            <div className="group peer flex items-center lg:hidden">
              ...
              <label
                htmlFor="menu"
                className="cursor-pointer rounded-lg bg-white p-2 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-gray-950 dark:ring-gray-800 dark:hover:bg-gray-900"
              >
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 256 256"
                  className="fill-gray-950 group-has-[input:checked]:hidden dark:fill-white"
                >
                ...
                <svg
                  ...
                  height="16"
                  viewBox="0 0 256 256"
                  className="hidden fill-gray-950 group-has-[input:checked]:block dark:fill-white"
                >
            ...
            <div className="absolute left-0 top-11 hidden w-full flex-col gap-2 rounded-lg border border-solid border-gray-100 bg-white px-6 py-4 shadow-md *:flex *:items-center *:gap-x-1.5 *:py-1.5 *:text-sm *:font-medium *:text-gray-950 peer-has-[:checked]:flex dark:border-gray-900 dark:bg-gray-950 dark:*:text-gray-50 lg:relative lg:left-0 lg:top-0 lg:flex lg:w-auto lg:flex-row lg:border-none lg:p-0 lg:shadow-none lg:*:px-2">
              <a href="/dashboard">
                Features
