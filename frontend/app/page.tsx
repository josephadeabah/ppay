      ...
      <footer className="bg-white dark:bg-gray-950">
        <div className="mx-auto flex flex-col items-center px-6 *:flex *:w-full *:flex-col *:items-center">
          ...
          <div className="gap-y-6 py-8 *:text-sm *:text-gray-500 lg:flex-row lg:justify-between">
            <p>&copy; 2024 Paysight.live. A product of <a href="https://www.pnpmmedia.com" target="_blank" rel="noreferrer" className="text-blue-600 hover:*:text-gray-950 dark:hover:*:text-gray-50">PNPM Media Digital.</a> &nbsp;All Rights Reserved.</p>
