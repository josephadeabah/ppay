...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={twMerge(
      "h-11 px-6 text-left align-middle text-xs font-medium text-gray-600 dark:text-gray-400 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={twMerge(
      "h-[4.5rem] overflow-hidden px-6 py-2 align-middle text-sm font-medium text-gray-900 dark:text-gray-100 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
